...
\textbf{\large{Bachelor of Science:}} Indian Institute of Technology, Kanpur \emph	{CPI: \textbf{8.2*/10.0} } \hfill\textit{July'14-Present}\vspace{0.1cm}\\
...
\item Ranked \textbf{161th} on \href{http://codechef.com/users/Swastik1996} {\textbf{Codechef}} among 25,000 active Indian users in short contests
...
\vspace{-0.2cm}
\begin{itemize}
\item \textbf{Paper Shredder(Course Project for TA202A under Dr. Arvind Kumar)}   \hfill\textit{ Aug'15 - Nov'15}
\begin{itemize}
\item Designed and fabricated a low cost Paper Shredder out of mild steel
\item Manufactured various parts such as shafts, blades and washers and assembled them together
\item Acquired skills such as drilling, milling, turning
\end{itemize}

\item \textbf{Mars Rover(Course Project for TA201A under Dr. Krishanu Biswas)}   \hfill\textit{ Jan'16 - April'16}
\begin{itemize}
\item Designed and fabricated a model for the Mars Rover out of mild steel
\item Manufactured parts such as wheels, drill arms and assembled them together
\item Acquired skills such as casting, welding and brazing
\end{itemize}
\end{itemize}
\vspace{-0.4cm}
